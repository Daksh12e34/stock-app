...
# ----------------------------------------------------------------------------
# CUSTOM CSS — FINTECH DARK THEME (ENHANCED)
# ----------------------------------------------------------------------------
st.markdown(
    """
    <style>
    ...
    .stApp {
        background:
            radial-gradient(circle at 15% 0%, rgba(59,130,246,0.10) 0%, transparent 45%),
            radial-gradient(circle at 85% 100%, rgba(168,85,247,0.08) 0%, transparent 45%),
    ...
    div[data-testid="stMetric"]:hover {
        ...
        border-color: #3b82f6;
        box-shadow: 0 8px 28px rgba(59,130,246,0.18), inset 0 1px 0 rgba(255,255,255,0.04);
    }
    ...
    details:hover { border-color: #2f3947 !important; }
...
# ----------------------------------------------------------------------------
# LIVE TICKER TAPE (pure visual, no backend calls)
# ----------------------------------------------------------------------------
_ticker_items = [
